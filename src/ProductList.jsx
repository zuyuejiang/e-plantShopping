    ...
    return (
            ...
            <div style={styleObjUl}>
                ...
                <div> 
                    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
                            ...
                            <span style={{ position: 'absolute', top: '30px', right: '30px', backgroundColor: 'transparent', color: 'white', borderRadius: '50%', padding: '5px 10px', fontSize: '25px' }}>
                                {totalQuantity}
                            </span> 
                        </h1>
                    </a>
        ...
        <div className="product-grid">
                ...
                <div key={index} style={{ textAlign: 'center'}}>
                    <h1><div style={{ textDecoration: 'overline underline' ,textDecorationThickness: '1.5px',  fontSize: '34px', paddingTop: '10px',lineHeight: '2'}}>{category.category}</div></h1>
